...
abstract contract PauseUpgradeable is Initializable, PausableUpgradeable {
	 ...
	 * @dev Standard Initializable contract behavior. The contract is not paused by default.
	 *
	 * Calling Conditions:
	 *
	 ...
	 * @dev Override this function to implement RBAC control for the pause.
	 */
	function _authorizePause() internal virtual;

	/**
	 * @notice This function is designed to be overridden in inheriting contracts.
	 * @dev Override this function to implement RBAC control for the unpause.
	 */
	function _authorizeUnpause() internal virtual;
