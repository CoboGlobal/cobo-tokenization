 ...
 * @notice This abstract contract provides internal contract logic for upgrading the contract URI.
 */
abstract contract ContractUriUpgradeable is Initializable, ContextUpgradeable {
	 ...
	 * @dev Standard Initializable contract behavior. The contract URI is set to the provided URI.
	 *
	 * Calling Conditions:
	 *
	 ...
	 * @dev This function emits a {ContractUriUpdated} event. The caller must hold the "MANAGER_ROLE" role.
	 *
	 ...
	 * @dev Override this function to implement RBAC control for the contract URI update.
	 */
